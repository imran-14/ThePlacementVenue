...
<html>
<head>
	<title>Instructions - Level 2</title>
...
<header>
	...
	<div id="container">
		...
		<center><a onclick="return goToTest();" href="level2.php" style='text-decoration:none; color:white;' ><h3 id="confirm-redirect" >I am ready to start the test</h3></a></center>
		</div>
	</div>
	<script>
		function goToTest()
