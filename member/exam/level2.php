...
if(isset($_POST['submitbtn']))
{
	...
	if($test_status != 'Not yet completed')
		mysql_query("UPDATE users SET `test_level2` = '$test_status' WHERE `usn`='$user'");
...
<div id="container">
	<div id="headLabel">
		Level 2 - Technical and Skills Test 1<span id="timer">Time left :
	...
	<div id="content" >
		...
		<div id="insSub">
			...
			<form method="post">
				<input type="text" name="test_details" id="test-detail" value="Not yet taken" style="display:"">
